...
<Note>Pro feature. Requires a Pidgeon account with Post Pro entitlement. It ships with the Post desktop app and the licensed CLI, not the free `dotnet tool install` build.</Note>
