...
<Note>Vendor-profile management (`pidgeon config`) ships with the Post desktop app and the licensed CLI, not the free `dotnet tool install` build. If you installed only the free CLI, these commands are delivered through Post.</Note>
